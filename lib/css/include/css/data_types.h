...
LCUI_API LCUI_BOOL css_parse_string_value(css_style_value_t *val, const char *str);
LCUI_API LCUI_BOOL css_parse_url_value(css_style_value_t *s, const char *str);
LCUI_API LCUI_BOOL css_parse_color_value(css_style_value_t *val, const char *str);
